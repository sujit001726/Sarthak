                        ...
                        <div class="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm flex flex-col gap-8">
                            <div class="flex flex-wrap items-center justify-between gap-6">
                                ...
                                <div class="relative w-full md:w-80 group">
                                    ...
                                    <input type="text" id="applicantSearchInput" placeholder="Search by name or role..."
                    ...
                    if (searchInput) {
                        searchInput.addEventListener('input', function(e) {
                            ...
                            applicantCards.forEach(card => {
                                ...
                                const roleElement = card.querySelector('p span.text-primary.italic');
                                
                                let matchFound = false;
                                if (nameElement && nameElement.textContent.toLowerCase().includes(searchTerm)) {
                                    matchFound = true;
                                }
                                if (roleElement && roleElement.textContent.toLowerCase().includes(searchTerm)) {
                                    matchFound = true;
                                }
