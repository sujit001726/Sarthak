        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item active"><a href="admin?action=candidates" class="nav-link"><i class="fas fa-user-graduate"></i> Candidates</a></li>
    ...
    <main class="main-wrapper">
        ...
        <div class="content-area">
            <div class="content-card" style="min-height: 400px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; color: var(--text-dim);">
                ...
                <h2>Welcome to Candidates Database</h2>
                <p style="margin-top: 10px; max-width: 600px;">This module allows you to interact with all functions related to Candidates Database. The full data integration is currently being mapped to the backend API.</p>
