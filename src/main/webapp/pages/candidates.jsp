...
<head>
    ...
    <style>
        ...
        .modal-box { background:#fff; border-radius:14px; padding:28px 32px; width:100%; max-width:440px; box-shadow:0 20px 60px rgba(0,0,0,0.2); }
        .profile-avatar { width:72px; height:72px; border-radius:16px; margin-bottom:12px; }
        .profile-row { display:flex; justify-content:space-between; padding:8px 0; border-bottom:1px solid #f1f5f9; font-size:0.88rem; }
        .profile-row:last-child { border-bottom:none; }
        .profile-label { color:#64748b; font-weight:600; }
        .profile-val { color:#1e293b; }
    </style>
</head>
<body>
            ...
            <div class="content-card animate-fade">
                <div class="card-header">
                    <div>
                        ...
                        <p style="font-size:0.8rem;color:var(--text-dim);">Total: ${candidates.size()} candidates</p>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <div style="display:flex;align-items:center;gap:12px;">
                                            <img src="https://ui-avatars.com/api/?name=${c.name}&background=random" style="width:40px;height:40px;border-radius:12px;">
                                            <div>
                                    ...
                                    <td>
                                        <span class="status-badge"
                                            style="background:${c.status == 'shortlisted' ? '#f0fdf4' : (c.status == 'applied' ? '#eff6ff' : '#fef2f2')};
                                    ...
                                    <td>
                                        <div style="display:flex;gap:8px;">
                                            ...
                                            <!-- Download (placeholder — links to resume if available) -->
                                            <a class="btn-sm btn-outline" title="Download Resume"
                                                href="admin?action=downloadResume&id=${c.id}" style="display:inline-flex;align-items:center;">
                                                <i class="fas fa-download"></i>
                                            </a>
                                            <!-- Delete -->
                                            <button class="btn-sm btn-outline" style="color:var(--danger)" title="Delete"
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div style="padding:4rem;text-align:center;color:var(--text-dim);">
                                            ...
                                            <a href="admin?action=addCandidate" class="btn-sm btn-primary" style="margin-top:1rem;text-decoration:none;display:inline-block;">Add first candidate</a>
                                        </div>
                                    </td>
                                </tr>
                            </c:if>
    ...
    <div class="modal-overlay" id="profileModal">
        <div class="modal-box">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:16px;">
                ...
                <button onclick="closeProfile()" style="background:none;border:none;font-size:1.3rem;cursor:pointer;color:#94a3b8;">&times;</button>
            </div>
            <div class="profile-row"><span class="profile-label">Phone</span><span class="profile-val" id="pm-phone"></span></div>
            <div class="profile-row"><span class="profile-label">Experience Level</span><span class="profile-val" id="pm-level"></span></div>
            <div class="profile-row"><span class="profile-label">Status</span><span class="profile-val" id="pm-status"></span></div>
        ...
        <div class="modal-box" style="max-width:380px;text-align:center;">
            ...
            <form id="deleteForm" action="admin" method="POST">
                ...
                <div style="display:flex;gap:10px;justify-content:center;">
                    ...
                    <button type="submit" class="btn-sm btn-primary" style="background:#ef4444;border-color:#ef4444;">Delete</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        function confirmDelete(id, name) {
            ...
            document.getElementById('del-msg').textContent = 'This will permanently remove "' + name + '" from the database.';
