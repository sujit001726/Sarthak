    ...
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        ...
        <head>
            ...
            <style>
                @media (max-width: 1024px) {
                    ...
                    .welcome-msg p { display: none !important; }
                    ...
                    .content-area { padding: 10px 0 !important; }
                    .dashboard-grid { 
                    ...
                    /* Calendar */
                    #np-day-hdr div, #np-grid div {
                        font-size: 0.75rem !important;
                        padding: 5px 2px !important;
                    }
                    #np-bs-label { font-size: 0.85rem !important; }
                }
            </style>
        </head>
        ...
        <body>
            ...
            <jsp:include page="includes/header.jsp">
                <jsp:param name="title" value="Good morning, ${adminName != null ? adminName : 'Sujit'}" />
                <jsp:param name="subtitle" value="Here's what you need to focus on today" />
            </jsp:include>
                    ...
                    <section class="stats-container">
                        <div class="stat-card">
                            <div class="stat-header">
                                ...
                                <div class="stat-icon-mini" style="background:#f0fdf4;color:#064e3b;"><i
                                        class="fas fa-briefcase"></i></div>
                            </div>
                            <span class="stat-label">All Jobs</span>
                            <a href="admin?action=jobs" class="stat-more">View More <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <div class="stat-card">
                            <div class="stat-header">
                                <span class="stat-value">${userCount}</span>
                                <div class="stat-icon-mini" style="background:#ecfdf5;color:#059669;"><i
                                        class="fas fa-users"></i></div>
                            </div>
                            <span class="stat-label">Total Candidates</span>
                            <a href="admin?action=candidates" class="stat-more">More Info <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <div class="stat-card">
                            <div class="stat-header">
                                <span class="stat-value">${appCount}</span>
                                <div class="stat-icon-mini" style="background:#f0fdfa;color:#0d9488;"><i
                                        class="fas fa-file-alt"></i></div>
                            </div>
                            <span class="stat-label">Total Applications</span>
                            <a href="admin?action=jobBoard" class="stat-more">More Info <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <div class="stat-card">
                            <div class="stat-header">
                                <span class="stat-value">${interviewCount}</span>
                                <div class="stat-icon-mini" style="background:#ecfccb;color:#65a30d;"><i
                                        class="fas fa-video"></i></div>
                            </div>
                            <span class="stat-label">Total Interviews</span>
                            <a href="admin?action=interviews" class="stat-more">More Info <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <div class="stat-card">
                            <div class="stat-header">
                                <span class="stat-value">${hiredCount}</span>
                                <div class="stat-icon-mini" style="background:#dcfce7;color:#166534;"><i
                                        class="fas fa-check-circle"></i></div>
                            </div>
                            <span class="stat-label">Total Hired</span>
                            <a href="admin?action=shortlisted" class="stat-more">More Info <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                        <div class="stat-card">
                            <div class="stat-header">
                                <span class="stat-value">${rejectedCount}</span>
                                <div class="stat-icon-mini" style="background:#fef2f2;color:#991b1b;"><i
                    ...
                    <div class="dashboard-grid">
                            ...
                            <div class="content-card">
                                <div class="card-header">
                                    ...
                                    <div>
                                        ...
                                        <a href="admin?action=addJob" class="btn-sm btn-primary"
                                            style="text-decoration:none;">Create Job Ad +</a>
                                    </div>
                                </div>
                                <table class="data-table">
                                    ...
                                    <tbody>
                                        <c:forEach var="job" items="${recentJobs}">
                                            <tr>
                                                <td>
                                                    <div class="job-row"><span
                                                            class="job-title">${job.title}</span><span
                                                            class="job-meta">W1</span></div>
                                                </td>
                                                <td><span
                                                        style="color: var(--text-dim); font-size: 0.85rem;">${job.companyName}</span>
                                                </td>
                                        ...
                                        <c:if test="${empty recentJobs}">
                                            <tr>
                                                <td colspan="4" style="text-align:center;color:var(--text-dim);">No job
                                                    ads found</td>
                                            </tr>
                                        </c:if>
                                    </tbody>
                            ...
                            <div class="content-card">
                                ...
                                <div class="progress-item">
                                    ...
                                    <div class="progress-bar">
                                        <div class="progress-fill" style="width:45%;background:#064e3b;"></div>
                                    </div>
                                </div>
                                <div class="progress-item">
                                    <div class="progress-info"><span>Intermediate</span><span>30%</span></div>
                                    <div class="progress-bar">
                                        <div class="progress-fill" style="width:30%;background:#0f766e;"></div>
                                    </div>
                                </div>
                                <div class="progress-item">
                                    <div class="progress-info"><span>Senior</span><span>15%</span></div>
                                    <div class="progress-bar">
                                        <div class="progress-fill" style="width:15%;background:#14b8a6;"></div>
                                    </div>
                                </div>
                                <div class="progress-item">
                                    <div class="progress-info"><span>Expert</span><span>10%</span></div>
                                    <div class="progress-bar">
                                        <div class="progress-fill" style="width:10%;background:#2dd4bf;"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="grid-right">
                            <div class="content-card">
                                ...
                                <div class="donut-container">
                                    ...
                                    <div class="donut-center">
                                        ...
                                        <span class="lbl" style="color: #064e3b; font-weight: 700;">Total
                                            Candidates</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="content-card" style="padding:0;overflow:hidden;">
                                <div
                                    style="background:#064e3b;color:#fff;display:flex;justify-content:space-between;align-items:center;padding:8px 12px;">
                                    <div id="np-bs-label" style="font-size:1rem;font-weight:700;letter-spacing:0.5px;">
                                    </div>
                                    <div style="display:flex;align-items:center;gap:6px;">
                                        <button onclick="npPrev()"
                                            style="background:rgba(255,255,255,0.25);border:none;color:#fff;font-size:1.2rem;cursor:pointer;border-radius:3px;width:26px;height:26px;line-height:1;">&#8249;</button>
                                        <span id="np-ad-label"
                                            style="font-size:0.78rem;font-weight:600;white-space:nowrap;"></span>
                                        <button onclick="npNext()"
                                            style="background:rgba(255,255,255,0.25);border:none;color:#fff;font-size:1.2rem;cursor:pointer;border-radius:3px;width:26px;height:26px;line-height:1;">&#8250;</button>
                                    </div>
                                </div>
                                <div id="np-day-hdr"
                                    style="display:grid;grid-template-columns:repeat(7,1fr);background:#0f5c4a;"></div>
                                <div id="np-grid"
                                    style="display:grid;grid-template-columns:repeat(7,1fr);border-left:1px solid #d1fae5;">
                                </div>
                                <div id="np-strip"
                                    style="background:#f0fdf4;text-align:center;font-size:0.72rem;color:#064e3b;padding:4px;font-weight:600;border-top:1px solid #d1fae5;">
                                </div>
                            </div>
