...
<head>
    ...
    <title>Sarthak | Quiz Designer Tool</title>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    <li class="nav-item active"><a href="admin?action=quizzes" class="nav-link"><i class="fas fa-pen-nib"></i> Quiz Designer</a></li>
    ...
    <main class="main-wrapper">
        ...
        <div class="content-area">
            <div class="content-card" style="min-height: 400px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; color: var(--text-dim);">
                <i class="fas fa-pen-nib" style="font-size: 4rem; color: var(--primary); margin-bottom: 20px;"></i>
                <h2>Welcome to Quiz Designer Tool</h2>
                <p style="margin-top: 10px; max-width: 600px;">This module allows you to interact with all functions related to Quiz Designer Tool. The full data integration is currently being mapped to the backend API.</p>
