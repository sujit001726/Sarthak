...
<head>
    ...
    <title>Sarthak | Shortlisted Candidates</title>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item active"><a href="admin?action=shortlisted" class="nav-link"><i class="fas fa-check-double"></i> Shortlisted</a></li>
                </ul>
            </div>
        </nav>
    ...
    <main class="main-wrapper">
        ...
        <div class="content-area">
            <div class="content-card" style="min-height: 400px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; color: var(--text-dim);">
                <i class="fas fa-check-double" style="font-size: 4rem; color: var(--primary); margin-bottom: 20px;"></i>
                <h2>Welcome to Shortlisted Candidates</h2>
                <p style="margin-top: 10px; max-width: 600px;">This module allows you to interact with all functions related to Shortlisted Candidates. The full data integration is currently being mapped to the backend API.</p>
