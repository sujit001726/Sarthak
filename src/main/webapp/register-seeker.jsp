...
<head>
    ...
    <meta name="description" content="Join Sarthak as a Job Seeker. Find your dream career in Nepal.">
    <title>Seeker Registration — Sarthak</title>
...
<div class="w-full max-w-[1200px] min-h-[500px] bg-white rounded-3xl overflow-hidden shadow-[0_30px_100px_rgba(29,62,53,0.15)] flex flex-col md:flex-row animate-fadeIn">
        ...
        <div class="relative z-20 h-full p-8 md:p-12 flex flex-col justify-between">
            ...
            <div class="hidden md:block animate-slideInLeft" style="animation-delay: 0.2s;">
                <p class="text-white text-[1.6rem] font-extrabold leading-tight mb-4">
                    Build Your Professional Future in Nepal.
                </p>
                <p class="text-white/70 text-sm max-w-[300px]">
                    Join thousands of job seekers who found their success through our platform.
                </p>
            </div>
    ...
    <div class="flex-1 bg-white p-10 md:p-16 flex flex-col justify-center overflow-y-auto">
        <div class="max-w-[440px] mx-auto w-full">
            <h1 class="text-3xl font-extrabold text-[#1a1a1a] mb-2">Create Seeker Account</h1>
            ...
            <form action="${pageContext.request.contextPath}/register" method="post" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="fullName" class="block text-xs font-bold text-[#333] mb-1.5 uppercase tracking-wider">Full Name</label>
                        <input type="text" id="fullName" name="fullName" class="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-gray-300" placeholder="John Doe" required>
                    </div>
                    <div>
                        <label for="email" class="block text-xs font-bold text-[#333] mb-1.5 uppercase tracking-wider">Email Address</label>
                        <input type="email" id="email" name="email" class="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-gray-300" placeholder="john@example.com" required>
                    </div>
                </div>
