...
<%-- Sarthak Job Portal Job Seeker Registration Page: Collects profile information and handles job seeker account registration --%>
                ...
                <form action="${pageContext.request.contextPath}/register" method="post" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="<c:out value='${email}'/>" class="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-gray-300" placeholder="john@example.com" required>
                        </div>
                    </div>
