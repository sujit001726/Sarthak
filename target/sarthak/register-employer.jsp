            ...
            <div class="max-w-[460px] mx-auto w-full">
                ...
                <form action="${pageContext.request.contextPath}/register" method="post" class="space-y-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" id="email" name="email" class="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all placeholder:text-gray-300" placeholder="hr@company.com" required>
                    </div>
